  ...
  return (
    <div className="bg-white p-6 rounded-xl border hover:shadow-md transition-shadow flex flex-col h-full">
      ...
      <div className="mb-4 flex-1">
        ...
        <p className="text-xs text-gray-500">By {author} • {uploadedAt}</p>
      </div>
      ...
      <div className="pt-4 border-t mt-auto">
        ...
        <Button variant="outline" className="w-full flex items-center justify-center gap-2 group hover:border-blue-500 hover:text-blue-600">
