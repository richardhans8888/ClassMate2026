      ...
      <div className="flex justify-between items-center p-6 z-10">
        <div>
          <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            <span className={`w-2 h-2 rounded-full ${isListening ? 'bg-indigo-500 animate-pulse' : isSpeaking ? 'bg-green-500 animate-pulse' : 'bg-gray-400'}`}></span>
            Voice Mode
          </h2>
        ...
        <div className="relative flex items-center justify-center">
          <motion.div
            animate={{
              ...
              opacity: isListening || isSpeaking ? [0.2, 0.5, 0.2] : [0.05, 0.2, 0.05],
            }}
            transition={{ duration: isListening || isSpeaking ? 2 : 5, repeat: Infinity, ease: 'easeInOut' }}
          ...
          <motion.div
            animate={{
              ...
              opacity: isListening || isSpeaking ? [0.3, 0.6, 0.3] : [0.1, 0.3, 0.1],
            }}
            transition={{ duration: isListening || isSpeaking ? 1.5 : 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }}
          ...
          <motion.div
            animate={{
              ...
              boxShadow: isListening
                ...
                : isSpeaking
                ? ['0 0 80px rgba(34,197,94,0.5)', '0 0 120px rgba(34,197,94,0.8)', '0 0 80px rgba(34,197,94,0.5)']
                : ['0 0 40px rgba(99,102,241,0.2)', '0 0 60px rgba(99,102,241,0.3)', '0 0 40px rgba(99,102,241,0.2)'],
            }}
