        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div 
              ...
              onClick={() => router.push('/tutor-studio/courses')}
              role="button"
            ...
            <motion.div 
              ...
              onClick={() => router.push('/tutors/alan-grant')}
              role="button"
            ...
            >
               ...
               <div className="flex items-center justify-between mt-auto">
                  ...
                  <button 
                    className="bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium px-4 py-2 rounded-lg transition-all shadow hover:shadow-md active:scale-95"
                    onClick={(e) => { 
                      e.stopPropagation(); 
