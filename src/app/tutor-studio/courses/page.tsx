  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <button className="flex flex-col items-center justify-center h-full min-h-[250px] rounded-2xl border-2 border-dashed border-gray-800 hover:border-teal-500/50 hover:bg-teal-500/5 transition-all group">
