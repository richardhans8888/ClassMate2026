...
// Mock Data
const students = [
  { id: 1, name: "Sarah Jenkins", status: "Online", lastSeen: "Last seen 2m ago", progress: 85, avatar: "/avatars/sarah.jpg", needsAttention: false },
  { id: 2, name: "Michael Chen", status: "Offline", lastSeen: "Needs Attention", progress: 42, avatar: "/avatars/michael.jpg", needsAttention: true },
  { id: 3, name: "David Kim", status: "Offline", lastSeen: "2h ago", progress: 78, avatar: "/avatars/david.jpg", needsAttention: false },
  { id: 4, name: "Emily Davis", status: "Online", lastSeen: "Online", progress: 92, avatar: "/avatars/emily.jpg", needsAttention: false },
  { id: 5, name: "Mark Wilson", status: "Offline", lastSeen: "5h ago", progress: 65, avatar: "/avatars/mark.jpg", needsAttention: false },
];

const modules = [
  { id: 1, title: "Lecture Notes: Derivatives", type: "pdf", status: "Published", uploaded: "Uploaded yesterday", views: 45 },
  { id: 2, title: "Research: Intro to Quantum Mechanics", type: "doc", status: "Draft", uploaded: "Draft saved 2h ago", views: 0 },
  { id: 3, title: "Video: Practical Application", type: "video", status: "Published", uploaded: "24 views", views: 24 },
];
      ...
      <header className="flex justify-between items-center bg-[#15181E] p-6 rounded-2xl border border-gray-800">
        <div>
          <div className="flex items-center gap-3 mb-1">
            <h1 className="text-2xl font-bold text-white">Advanced Calculus - Fall Cohort</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-[#15181E] p-6 rounded-2xl border border-gray-800">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Student activity over the last 7 days</p>
                </div>
              ...
              <div className="flex items-end justify-between h-32 gap-2 mt-4">
                {[40, 65, 45, 80, 60, 25, 15].map((height, i) => (
                  <div key={i} className="w-full bg-[#1A1F26] rounded-t-sm relative group">
                    <div 
          ...
          <div className="bg-[#15181E] rounded-2xl border border-gray-800 overflow-hidden">
            ...
            <div className="p-2">
              ...
              <div className="space-y-1">
                {modules.map((module) => (
                  <div key={module.id} className="grid grid-cols-12 items-center px-4 py-3 hover:bg-[#1A1F26] rounded-lg transition-colors group">
                    <div className="col-span-6 flex items-center gap-3">
                      <div className={`p-2 rounded-lg ${
                        module.type === 'pdf' ? 'bg-red-500/10 text-red-400' :
                        module.type === 'doc' ? 'bg-blue-500/10 text-blue-400' :
                        'bg-purple-500/10 text-purple-400'
                      }`}>
                        {module.type === 'pdf' && <FileText className="w-5 h-5" />}
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{module.uploaded}</div>
                      </div>
                    </div>
          ...
          <div className="flex justify-end pt-4 border-t border-gray-800">
             <Button variant="ghost" className="text-red-400 hover:text-red-300 hover:bg-red-900/10">
                End Course & Archive
             </Button>
          </div>
        ...
        <div className="bg-[#15181E] rounded-2xl border border-gray-800 flex flex-col h-full">
              ...
              <div key={student.id} className="group">
                <div className="flex items-center gap-3 mb-2">
                  <div className="relative">
                    ...
                    <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-[#15181E] ${
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-xs font-bold text-white">{student.progress}%</div>
                    </div>
                    <div className="flex items-center gap-1.5 text-xs">
                      {student.needsAttention ? (
                        ...
                        <span className="text-gray-500">
                           {student.status === 'Online' ? 'Online' : 'Offline'} • {student.lastSeen}
                        </span>
                      )}
                    </div>
                  </div>
          ...
          <div className="p-4 border-t border-gray-800 mt-auto">
            <Button variant="outline" className="w-full border-gray-700 text-gray-300 hover:bg-[#1A1F26] hover:text-white">
              View Full Roster
            </Button>
          </div>
        </div>
